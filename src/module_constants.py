...
#COOP END##################################################################
slot_agent_last_shield_bash_time = 38656
###
###
...
####Mordechai EPC Begin #Lord execution system patched to an extent
slto_dead = 146
...
slot_scene_prop_number_of_agents_pushing = 3 #for belfries only
slot_scene_prop_next_entry_point_id      = 4 #for belfries only
slot_scene_prop_belfry_platform_moved    = 5 #for belfries only
slot_scene_prop_slots_end                = 6
#scene_prop_next_action_time = 7
########################################################
rel_enemy   = 0
rel_neutral = 1
rel_ally    = 2
...
#kingdom_ladies_begin = "trp_tt_lady_01_01"
#kingdom_ladies_end = "trp_tt_lady_end"
...
##Adjust battle_size, battlesize, etc in here: for actual troops!
##battle size
...
####TERRAIN END
#
####Extend to other cmds
##coop_set_setting_use_dmod = 68
...
##coop_set_g_player_party_icon = 74
#coop_set_sp_shield_bash = 75
#coop_set_sp_shield_bash_ai = 76
#coop_set_setting_use_spearwall = 77
##coop_set_g_battle_preparation = 78
##coop_set_g_battle_preparation_phase = 79
#coop_set_g_rand_rain_limit = 80
##coop_set_g_reinforcement_waves = 81
#coop_set_tom_sand_storm_chance = 82 #Here
...
##coop_set_crusader_faction = 89
##coop_set_crusader_party_id = 90
##coop_set_crusader_state = 91
##coop_set_freelancer_state = 92
##coop_set_men_are_pleased = 93
##coop_set_tom_use_longships = 94
##coop_set_use_feudal_lance = 95
#coop_set_historical_banners = 96
#coop_set_randomize_player_shield = 97
#coop_set_torch_chance = 98
#coop_set_camera_mode = 99
#coop_sand_storm = 100
##Additional STEP 1 Numerical settings template for numerical presentation, options, numbers, define your things below, as well as above, take an example, the below are used with the above "coop_set_tom_sand_storm_chance = 82" 
#coop_sandstorm_chance_min               = 0
#coop_sandstorm_chance_def           	= 20
#coop_sandstorm_chance_max              = 101
#coop_torch_chance_min               = 0 # 0 default
##Adjust torch chance here and in module_coop_scripts assigns (total of 2)
#coop_torch_chance_def           	= 3 #Default 25
##End adjust torch chance here
#coop_torch_chance_max              = 101
##coop_set_belfry_sound              = 102
##coop_set_belfry_position              = 103
##coop_use_belfry              = 104
#coop_voiceset              = 105
