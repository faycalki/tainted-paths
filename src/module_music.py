...
tracks = [
	...
	("tavern_2", "tavern_2.ogg", mtf_start_immediately|mtf_sit_killed|mtf_module_track, 0), #
	("tavern_1", "tavern_1.ogg", mtf_start_immediately|mtf_sit_killed|mtf_module_track, 0), #
	...
	("calm_night_2", "calm_night_2.ogg", mtf_sit_travel|mtf_module_track, 0), #
...
#	("euros10", "(Euro_Mobilize_11)_We_Got_Trouble.mp3", mtf_sit_travel|mtf_sit_main_title|mtf_sit_multiplayer_fight|mtf_sit_fight|mtf_sit_siege|mtf_module_track, 6969),
	...
	#OLD WARWOLF
#	("outdoor_beautiful_land", "outdoor_beautiful_land.ogg", mtf_start_immediately|mtf_sit_tavern|mtf_module_track, 0),
#

#	("town_khergit", "town_khergit.ogg", mtf_start_immediately|mtf_sit_multiplayer_fight|mtf_module_track, 0),
#

#
#	("lords_hall_khergit", "lords_hall_khergit.ogg", mtf_start_immediately|mtf_sit_ambushed|mtf_module_track, 0),
#

#
#	("middle_eastern_travel", "middle_eastern_travel.ogg", mtf_start_immediately|mtf_sit_town_infiltrate|mtf_module_track, 0),
#

#
#	("lords_hall_nord", "lords_hall_nord.ogg", mtf_start_immediately|mtf_sit_day|mtf_module_track, 0),
#

#
#	("town_rhodok", "town_rhodok.ogg", mtf_start_immediately|mtf_sit_siege|mtf_module_track, 0),
#
...
#
#	("fight_1", "fight_1.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("fight_2", "fight_2.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("fight_3", "fight_3.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("fight_as_khergit", "fight_as_khergit.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("fight_as_nord", "fight_as_nord.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("fight_as_rhodok", "fight_as_rhodok.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("fight_as_vaegir", "fight_as_vaegir.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("fight_while_mounted_1", "fight_while_mounted_1.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("fight_while_mounted_2", "fight_while_mounted_2.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("warband_action", "warband_action.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("warband_siege", "warband_siege.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("ambushed_by_khergit", "ambushed_by_khergit.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("ambushed_by_nord", "ambushed_by_nord.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("ambushed_by_rhodok", "ambushed_by_rhodok.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("ambushed_by_swadian", "ambushed_by_swadian.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
#
#	("ambushed_by_vaegir", "ambushed_by_vaegir.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),

	
	#("arena_1", "arena_1.ogg", mtf_start_immediately|mtf_sit_arena|mtf_module_track, 0),
	#("crazy_battle_music", "crazy_battle_music.ogg", mtf_start_immediately|mtf_sit_fight|mtf_module_track, 0),
	#("enter_the_juggernaut", "enter_the_juggernaut.ogg", mtf_start_immediately|mtf_sit_killed|mtf_module_track, 0),
	#("tavern_2", "tavern_2.ogg", mtf_start_immediately|mtf_sit_killed|mtf_module_track, 0),
	#("enter_the_juggernaut", "enter_the_juggernaut.ogg", mtf_start_immediately|mtf_sit_killed|mtf_module_track, 0),
...
#	("uncertain_homestead", "uncertain_homestead.ogg", mtf_start_immediately|mtf_sit_victorious|mtf_module_track, 0),
#
